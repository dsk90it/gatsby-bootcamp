  ...
  return (
    <header className={HeaderStyles.navbar}>
      <div className={`${HeaderStyles.container} container`}>
        <ul>
          <li><Link activeClassName={HeaderStyles.active} to="/">Home</Link></li>
          <li><Link activeClassName={HeaderStyles.active} to="/about">About</Link></li>
          <li><Link activeClassName={HeaderStyles.active} to="/blog">Blog</Link></li>
          <li><Link activeClassName={HeaderStyles.active} to="/contact">Contact</Link></li>
          <li className="ml--auto"><a href={data.site.siteMetadata.github} target="_blank" rel="noopener noreferrer">
